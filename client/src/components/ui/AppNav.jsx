        ...
        <>
            <nav className="fixed top-0 left-0 right-0 z-50" style={{background: "#fefdfb", borderBottom: `3px double #1c1c1c`}}>
                <div
                    ...
                    style={{borderBottom: `1px solid #1c1c1c`, fontSize: "11px", fontFamily: "'Libre Baskerville', Georgia, serif", color: "#4a4440"}}
                >
                ...
                <div className="flex items-center justify-between px-8 py-3">
                    ...
                    <div className="hidden md:flex items-center gap-8" style={{fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: "13px", letterSpacing: "0.05em", textTransform: "uppercase"}}>
                        {user ? (
                            <>
                                {[
                    ...
                    <div className="flex items-center gap-3" style={{fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: "13px"}}>
                        {user ? (
                            <>
                                <span style={{color: "#7a7570"}}>{user.name?.split(" ")[0]}</span>
                                <button onClick={handleLogout} className="flex items-center gap-1.5 px-3 py-1.5" style={{background: "transparent", color: "#7a7570", border: "1px solid #7a7570", cursor: "pointer", fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: "12px"}}>
                            ...
                            <button onClick={() => navigate("/register")} style={{background: "#1c1c1c", color: "#fefdfb", border: "1px solid #1c1c1c", cursor: "pointer", fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: "12px", letterSpacing: "0.05em", textTransform: "uppercase", padding: "6px 16px"}}>
                                Get Started
                            </button>
                        </>
                    )}
